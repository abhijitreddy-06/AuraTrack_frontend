    ...
    >
      ...
      <View style={styles.content}>
        ...
        <Text style={[styles.description, { color: colors.textSecondary }]}>
          Built by Abhijit Reddy❤️
        </Text>
        <Text style={[styles.version, { color: colors.textSecondary }]}>
          Version 1.0.0
        </Text>
        <Text style={[styles.description, { color: colors.textSecondary }]}>
          A calm place to keep track of your finances, habits, and everyday
          plans.
        </Text>
        <View
        ...
        >
          <View style={styles.row}>
            <Feather name="shield" size={19} color={colors.textSecondary} />
          ...
          <View style={styles.row}>
            <Feather name="file-text" size={19} color={colors.textSecondary} />
            <Text style={[styles.rowText, { color: colors.textPrimary }]}>
              Terms of service
            </Text>
          </View>
